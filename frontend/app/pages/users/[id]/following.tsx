      ...
      <Container>
        <Row>
            ...
            <Container>
                ...
                {following_state && (
                  <>
                    <Col sm={4}>
                      <External_Image
                        alt="User icon"
                        src={following_state.user.gravator_url}
                        width={70}
                        height={70}
                      />
                    </Col>
              ...
              {relationships_data &&
                ...
                id_checker(Number(id), user_data?.user?.id) && (
                  <>
                    <Row>
                      <Col sm={6} xs={6} className="text-secondary m-0 ml-3 border-right">
                        <Link
                          href={{
          ...
          <Col md={7}>
            ...
            {!id_checker(Number(id), user_data?.user?.id) && following_state && (
